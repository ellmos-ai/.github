...
<p align="center">
  <a href="https://github.com/ellmos-ai/open-ocean" style="display:block;width:100%;">
    <img src="https://raw.githubusercontent.com/ellmos-ai/.github/master/profile/assets/open-ocean-banner.png" alt="open-ocean — Befreie den Ozean" width="100%" style="width:100%;max-width:100%;display:block;border:2px solid rgba(2, 132, 199, 0.35);background-color:rgba(2, 132, 199, 0.2);box-shadow:0 0 16px rgba(2, 132, 199, 0.35);border-radius:8px;box-sizing:border-box;">
  </a>
</p>

## Öffentliches Repository-Verzeichnis

Dieses Verzeichnis ist vollständig für die öffentlichen `ellmos-ai`-Repositories (73 aktive Repos, 1 archiviert; 74 gesamt). Archivierte Repositories sind ausdrücklich gekennzeichnet. Zuletzt mit GitHub abgeglichen: 2026-09-23.

| Bereich | Repositories |
|---|---|
| Organisationsprofil | **[.github](https://github.com/ellmos-ai/.github)** - Org-Profil, Community-Health-Dateien und `llms.txt`; **[ellmos-ai.github.io](https://github.com/ellmos-ai/ellmos-ai.github.io)** - interaktive Karten und Ökosystem-Explorer |
...
| Modul | Fokus |
|---|---|
| **[swarm-ai](https://github.com/ellmos-ai/swarm_ai)** | Parallele LLM-Koordination |
...
| **[pasta-press](https://github.com/ellmos-ai/pasta-press)** | Lokale KI-Textpresse via Ollama: Stilveredelung, Übersetzung & KI-Marker-Bereinigung mit ehrlicher AI-Disclosure |
| **[project-docs-template](https://github.com/ellmos-ai/project-docs-template)** | Agentenfreundliche Projektdokumentationsvorlage mit START/STATE/TODO/DONE |
...
| **Fleet** | Die Multi-Host-Gruppierung derselben System-Instanzen — ein System, viele Maschinen, synchron gehalten. | [roshambo](https://github.com/ellmos-ai/roshambo) mit [system-gap-master](https://github.com/ellmos-ai/system-gap-master) |
...
Manche Kompositionen wachsen über die Stack-Ebene hinaus: Sie sind governierte Systeme mit eigener Identität, Policies und Lebenszyklus. Drei davon bilden unsere Vollsysteme — die Banner sind die Links:
...
| **[open-ocean](https://github.com/ellmos-ai/open-ocean)** | *Free the ocean*: das freie Community-Vollsystem des ellmos-Ökosystems. |
...
| **[hook-master](https://github.com/ellmos-ai/hook-master)** | Lokales Zeiger-Register und Materialisierung für Agent-Hooks — Geschwistermodul zu policy-registry. |
| **[source-resolver](https://github.com/ellmos-ai/source-resolver)** | Rollenbasierte Quellenauflösung für Skills: eine gestufte Leiter (Nutzerkonfiguration, eigenes Modul, Discovery-Vorschlag, Fremdanbieter, Dialog) statt jede Informationsquelle hart zu verdrahten. |
| **[grounding-seed](https://github.com/ellmos-ai/grounding-seed)** | Standalone-Bootstrap-Template für isolierte Module/Skills/Repos — Selbstkenntnis, Suche, Selbstversorgung, Migration bei Fund; delegiert an source-resolver, wenn importierbar. |
...
| **[prompt-listener](https://github.com/ellmos-ai/prompt-listener)** | Versioniertes Fork-Master-Template: 5-Stufen-Prompt-/Session-Analyse plus stdlib-only AgentEvent-v2-Provenienz-Schema (18 Sub-Ledger). Forken, wenn der Zweck divergiert — einzige Pflicht ist der FORKS.md-Eintrag. |
...
| **[decision-clicker](https://github.com/ellmos-ai/decision-clicker)** | Dateibasierte Entscheidungsketten mit Prüfspur und abgesichertem Undo — Bibliothek, CLI und lokale Web-Oberfläche. |
| **[session-checkpoint](https://github.com/ellmos-ai/session-checkpoint)** | Anwendungsneutraler Sitzungs-Checkpoint-Speicher mit Integritätsprüfung — einen Lauf sichern und später fortsetzen. |
| **[prompt-evidence-collector](https://github.com/ellmos-ai/prompt-evidence-collector)** | Prüffähige Erfassung von LLM-Interaktionen mit kryptografischem, reinem Hash-Evidenzspeicher. |

---

## Fach- und Spezialwerkzeuge

Module für ein konkretes Fachgebiet statt für die Agentenlaufzeit selbst — die Banner sind die Links, Details im [Öffentlichen Repository-Verzeichnis](#oeffentliches-repository-verzeichnis) oben:
...
Agenten-*Infrastruktur* — Koordination, Orchestrierung und Lifecycle für selbst mitgebrachte Agenten — liegt in **[swarm-ai](https://github.com/ellmos-ai/swarm_ai)**, **[roshambo](https://github.com/ellmos-ai/roshambo)**, **[MarbleRun](https://github.com/ellmos-ai/marblerun)** und **[coma](https://github.com/ellmos-ai/coma)**.
...
Projekte, die für öffentliche Hackathons und Wettbewerbe entstanden sind. Aufgeführt als Beiträge — es wird keine Platzierung behauptet. Die Telefon-Agenten [hungrycall](https://github.com/ellmos-ai/hungrycall), [ringedingeding](https://github.com/ellmos-ai/ringedingeding) und [researchcall](https://github.com/ellmos-ai/researchcall) stehen oben unter [Agenten](#agenten).
