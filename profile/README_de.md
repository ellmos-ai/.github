...
Dieses Verzeichnis ist vollständig für die veröffentlichten öffentlichen `ellmos-ai`-Repositories (54 verzeichnete Einträge, davon 1 archiviert). Archivierte Repositories sind ausdrücklich markiert. Zuletzt mit GitHub abgeglichen: 2026-08-08. Ein Live-API-Scan fand 54 aktive öffentliche Repositories; `bundles` bleibt bewusst außen vor, weil sein eigenes README es als privaten, schrittweise freizugebenden Build kennzeichnet.
...
| Kern- und System-Infrastruktur | **[sqlite-transit-sync](https://github.com/ellmos-ai/sqlite-transit-sync)** - lokale SQLite-Synchronisation über verifizierte Snapshots und konfigurierbare Merge-Policies auf Zeilenebene (Python 3.10+, null Abhängigkeiten); **[ellmos-scheduler](https://github.com/ellmos-ai/ellmos-scheduler)** - eigenständiger Scheduler und Laufaufzeichner für modulare ellmos-Stacks; **[policy-registry](https://github.com/ellmos-ai/policy-registry)** - lokales Pointer-Register für Policies, Regeln und Entscheidungen; **[system-explorer](https://github.com/ellmos-ai/system-explorer)** - evidenzbasierte Karten gewünschter Systemfunktionen und ihrer tatsächlichen Träger |
