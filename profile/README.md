...
This index is complete for the public `ellmos-ai` repositories (73 active repos, 1 archived; 74 total). Archived repositories are marked explicitly. Last checked against GitHub: 2026-09-23.
...
| Agent hooks, evidence and coordination | **[memoryhooker](https://github.com/ellmos-ai/memoryhooker)** - connects local memory sources to coding-agent lifecycle hooks (no network); **[workflowhooker](https://github.com/ellmos-ai/WORKFLOWHOOKER)** - configurable workflow checks at agent lifecycle events, zero dependencies; **[hook-master](https://github.com/ellmos-ai/hook-master)** - local-first pointer registry and materialization for agent hooks (sibling to policy-registry); **[roshambo](https://github.com/ellmos-ai/roshambo)** - multi-agent coordinator: serializable leases + outcome memory on CockroachDB; **[roshambo-starmap](https://github.com/ellmos-ai/roshambo-starmap)** - evidence artefact of the multi-vendor swarm run coordinated by roshambo; **[policy-registry](https://github.com/ellmos-ai/policy-registry)** - local-first registry for policies, rules and governance decisions with metadata pointers to canonical sources; **[source-resolver](https://github.com/ellmos-ai/source-resolver)** - staged role-based source resolution ladder for skills; **[grounding-seed](https://github.com/ellmos-ai/grounding-seed)** - standalone-bootstrap template for isolated modules/skills, delegates to source-resolver when importable; **[prompt-evidence-collector](https://github.com/ellmos-ai/prompt-evidence-collector)** - audit-ready capture of LLM interactions with a cryptographic, hash-only evidence store |
| Agent operations tooling | **[ticket-master](https://github.com/ellmos-ai/ticket-master)** - multi-provider ticket router and triage console for CLI coding agents; **[lock-master](https://github.com/ellmos-ai/lock-master)** - portable multi-agent file-lock system; **[system-gap-master](https://github.com/ellmos-ai/system-gap-master)** - serverless cross-machine sync yard; **[system-auditor](https://github.com/ellmos-ai/system-auditor)** - evidence-based system audits across machines with meta-audit bundling; **[compare-race](https://github.com/ellmos-ai/compare-race)** - same prompt to several models, stopwatch or true race, the starting model judges; **[prompt-listener](https://github.com/ellmos-ai/prompt-listener)** - fork-master template for prompt/session analysis with AgentEvent provenance schema; **[coma](https://github.com/ellmos-ai/coma)** - agent lifecycle layer (spawn, file protocol, status polling); **[companion-for-agy](https://github.com/ellmos-ai/companion-for-agy)** - PTY wrapper that makes agy (Gemini CLI) output readable for automation; **[decision-clicker](https://github.com/ellmos-ai/decision-clicker)** - file-based decision chains with audit trail, guarded undo and a local web UI; **[session-checkpoint](https://github.com/ellmos-ai/session-checkpoint)** - application-neutral session checkpoint storage with integrity checks |
| Agents | **[hungrycall](https://github.com/ellmos-ai/hungrycall)**, **[ringedingeding](https://github.com/ellmos-ai/ringedingeding)**, **[researchcall](https://github.com/ellmos-ai/researchcall)** - telephone agents built on CALL-E; plus agent roles shipped inside **[ticket-master](https://github.com/ellmos-ai/ticket-master)**, **[task-master](https://github.com/ellmos-ai/task-master)**, **[build-your-users-mind](https://github.com/ellmos-ai/build-your-users-mind)**, **[law-checker](https://github.com/ellmos-ai/rechtsabteilung)** and **[ai-media-editor](https://github.com/ellmos-ai/ai-media-editor)**, and as skills (research-agent, dev-soft-agent) in **[skills](https://github.com/ellmos-ai/skills)**; see [Agents](#agents) below |
...
The **[bundles](https://github.com/ellmos-ai/bundles)** repository hosts the recipe layer of the ellmos ecosystem — bundle manifests, catalogs, and composition knowledge. Our first bundle manifests are registered and undergoing staged rollout. First public candidate: the .MEMORY pillar set `usmc + gardener + task-master`.
...
<p align="center">
  ...
  <a href="https://github.com/ellmos-ai/ellmos-stack">
    <img src="https://raw.githubusercontent.com/ellmos-ai/ellmos-stack/master/assets/banner_v2.png" alt="ellmos-stack" width="880" style="border:2px solid #34d399;box-shadow:0 0 12px rgba(52,211,153,0.45);border-radius:8px;margin:5px;object-fit:cover">
  </a>
  <a href="https://github.com/ellmos-ai/agent-ops-stack">
    <img src="https://raw.githubusercontent.com/ellmos-ai/agent-ops-stack/main/assets/banner.png" alt="agent-ops-stack" width="880" style="border:2px solid #38bdf8;box-shadow:0 0 12px rgba(56,189,248,0.45);border-radius:8px;margin:5px;object-fit:cover">
  </a>
</p>
...
| **[ellmos-scheduler](https://github.com/ellmos-ai/ellmos-scheduler)** | Standalone local-first task scheduler and run recorder for modular ellmos stacks and autonomous LLM agent execution loops. |
...
| **[policy-registry](https://github.com/ellmos-ai/policy-registry)** | Local-first registry for policies, rules, and governance decisions with metadata pointers to canonical sources. |
| **[hook-master](https://github.com/ellmos-ai/hook-master)** | Local-first pointer registry and materialization for agent hooks — sibling to policy-registry. |
| **[source-resolver](https://github.com/ellmos-ai/source-resolver)** | Role-based source resolution for skills: a staged ladder (user config, own module, discovery proposal, foreign provider, dialogue) instead of hard-wiring every information source. |
| **[grounding-seed](https://github.com/ellmos-ai/grounding-seed)** | Standalone-bootstrap template for isolated modules/skills/repos — self-knowledge, search, self-provisioning, migration on find; delegates to source-resolver when it is importable. |
...
| **[system-auditor](https://github.com/ellmos-ai/system-auditor)** | Evidence-based system audits across machines — four audit tokens (time, domain, system, auditor), an aggregation ladder with enforced identifiability, model-manual meta reports. Extracted from ticket-master's TICKET-WRITER. |
| **[compare-race](https://github.com/ellmos-ai/compare-race)** | Same prompt to several models — sequential (stopwatch, clean per-lane timing) or parallel (true race), with repetitions per model; the starting model judges across quality, correctness, completeness, instruction fidelity and latency (time is only one dimension). Reuses the system-auditor identity logic. |
| **[prompt-listener](https://github.com/ellmos-ai/prompt-listener)** | Versioned fork-master template: 5-stage prompt/session analysis pipeline plus a stdlib-only AgentEvent v2 provenance schema (18 sub-ledgers). Fork it when your purpose diverges — the only duty is a FORKS.md entry. |
...
| **[decision-clicker](https://github.com/ellmos-ai/decision-clicker)** | File-based decision chains with audit trail and guarded undo — library, CLI and a local web UI. |
| **[session-checkpoint](https://github.com/ellmos-ai/session-checkpoint)** | Application-neutral session checkpoint storage with integrity checks — snapshot a run, resume it later. |
| **[prompt-evidence-collector](https://github.com/ellmos-ai/prompt-evidence-collector)** | Audit-ready capture of LLM interactions with a cryptographic, hash-only evidence store. |
...
<p align="center"><a href="https://github.com/ellmos-ai/rechtsabteilung"><img src="https://raw.githubusercontent.com/ellmos-ai/rechtsabteilung/main/assets/banner.png" alt="law-checker" width="560" style="border:2px solid #fbbf24;border-radius:8px;margin:0"></a><a href="https://github.com/ellmos-ai/worksheet-generator"><img src="https://raw.githubusercontent.com/ellmos-ai/worksheet-generator/main/assets/banner.png" alt="worksheet-generator" width="560" style="border:2px solid #2dd4bf;border-radius:8px;margin:0"></a><a href="https://github.com/ellmos-ai/steuer-assistent"><img src="https://raw.githubusercontent.com/ellmos-ai/steuer-assistent/main/assets/banner.png" alt="steuer-assistent" width="560" style="border:2px solid #34d399;border-radius:8px;margin:0"></a><a href="https://github.com/ellmos-ai/ellmos-voice-io"><img src="https://raw.githubusercontent.com/ellmos-ai/ellmos-voice-io/main/docs/assets/banner.png" alt="ellmos-voice-io" width="560" style="border:2px solid #38bdf8;border-radius:8px;margin:0"></a><a href="https://github.com/ellmos-ai/ellmos-tests"><img src="https://raw.githubusercontent.com/ellmos-ai/ellmos-tests/master/assets/banner-wide.png" alt="ellmos-tests" width="560" style="border:2px solid #4ade80;border-radius:8px;margin:0"></a><a href="https://github.com/ellmos-ai/clirec"><img src="https://raw.githubusercontent.com/ellmos-ai/clirec/main/assets/banner-b.png" alt="clirec" width="560" style="border:2px solid #fb7185;border-radius:8px;margin:0"></a><a href="https://github.com/ellmos-ai/project-docs-template"><img src="https://raw.githubusercontent.com/ellmos-ai/project-docs-template/main/assets/banner.png" alt="project-docs-template" width="560" style="border:2px solid #818cf8;border-radius:8px;margin:0"></a><a href="https://github.com/ellmos-ai/sqlite-transit-sync"><img src="https://raw.githubusercontent.com/ellmos-ai/sqlite-transit-sync/main/assets/banner.png" alt="sqlite-transit-sync" width="560" style="border:2px solid #a78bfa;border-radius:8px;margin:0"></a><a href="https://github.com/ellmos-ai/clip-storyboard-director"><img src="https://raw.githubusercontent.com/ellmos-ai/clip-storyboard-director/main/assets/banner.svg" alt="clip-storyboard-director" width="560" style="border:2px solid #f472b6;border-radius:8px;margin:0"></a></p>
...
Agent *infrastructure* — coordination, orchestration and lifecycle for agents you bring yourself — lives in **[swarm-ai](https://github.com/ellmos-ai/swarm_ai)**, **[roshambo](https://github.com/ellmos-ai/roshambo)**, **[MarbleRun](https://github.com/ellmos-ai/marblerun)** and **[coma](https://github.com/ellmos-ai/coma)**.
...
| **[cowork-protocol](https://github.com/ellmos-ai/cowork-protocol)** | The WebMCP Challenge (Devpost, 2026) | Reusable collaboration protocol and adaptive bridge for people, WebMCP apps, and web agents |
| **[FolderHome](https://github.com/ellmos-ai/FolderHome)** | Agents for Humans (Devpost, 2026) | Local-first Strands agent for safe household document workflows |
| **[NemoFold](https://github.com/ellmos-ai/NemoFold)** | Nebius Global AI Hackathon (Devpost, 2026) | Evidence-first document agent with persistent local memory |
| **[sentinel-fleet](https://github.com/ellmos-ai/sentinel-fleet)** | All Things Agentic Hackathon (Devpost, 2026) | Autonomous fleet security and monitoring agent cluster |
